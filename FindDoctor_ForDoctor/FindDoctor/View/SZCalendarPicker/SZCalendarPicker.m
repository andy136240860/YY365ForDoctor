...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if (i < firstWeekday) {
            ...
            [cell.dateLabel setTextColor:UIColorFromHex(0x6f6f6f)];//可选0x6f6f6f
            
            //this month
            if ([_today isEqualToDate:_date]) {
                if (day < [self day:_date]) {
                    [cell.dateLabel setTextColor:UIColorFromHex(0xcbcbcb)];
                }
...
//            if ([_today isEqualToDate:_date]) {
//                if (day == [self day:_date]) {
//                    [cell.dateLabel setTextColor:UIColorFromHex(0xcbcbcb)];//已选0x4898eb
//                }
//                else if (day == [self day:_selectedDate]){
//                    [cell.dateLabel setTextColor:UIColorFromHex(0x4898eb)];
//                }
//                else if (day < [self day:_date]) {
//                    [cell.dateLabel setTextColor:UIColorFromHex(0xcbcbcb)];//不可选
//                }
