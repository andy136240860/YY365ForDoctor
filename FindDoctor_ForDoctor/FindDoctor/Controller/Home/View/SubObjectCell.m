...
- (void)createContentView
{
    ...
    _titleLabel.textColor = UIColorFromRGB(170, 170, 170);
...
- (void)setSubobject:(SubObject *)subobject
{
    ...
    [_iconView setImageWithURL:[NSURL URLWithString:_subobject.imageURL] placeholderImage:[UIImage imageNamed:@"subobject_placeholder"]];
