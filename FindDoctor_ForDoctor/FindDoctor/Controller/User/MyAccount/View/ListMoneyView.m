...
- (void)initTitle{
    NSString *title1 = @"现金收入";
    NSString *title2 = @"诊金券收入";
    ...
    lineView.backgroundColor = UIColorFromHex(Color_Hex_Text_Title);
    ...
    [costButton setTitleColor:UIColorFromHex(Color_Hex_Text_Title) forState:UIControlStateNormal];
    ...
    [incomeButton setTitleColor:UIColorFromHex(Color_Hex_Text_Title) forState:UIControlStateNormal];
