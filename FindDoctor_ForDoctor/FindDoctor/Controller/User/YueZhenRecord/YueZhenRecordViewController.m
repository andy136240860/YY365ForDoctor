...
@interface YueZhenRecordViewController ()<DOPDropDownMenuDataSource, DOPDropDownMenuDelegate>
...
@implementation YueZhenRecordViewController
...
{
    return [YueZhenRecordCell defaultHeight];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YueZhenRecordCell *cell = (YueZhenRecordCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    if (cell == nil) {
        cell =  [[YueZhenRecordCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
