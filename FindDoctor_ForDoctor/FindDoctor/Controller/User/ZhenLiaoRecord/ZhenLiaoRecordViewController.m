...
#import "ZhenLiaoRecordCell.h"
#import "ZhenLiaoDetailViewController.h"
#import "TreatmentListAndDetailManager.h"

@interface ZhenLiaoRecordViewController ()<DOPDropDownMenuDataSource, DOPDropDownMenuDelegate>
...
@implementation ZhenLiaoRecordViewController
...
{
    return [ZhenLiaoRecordCell defaultHeight];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZhenLiaoRecordCell *cell = (ZhenLiaoRecordCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    if (cell == nil) {
        cell =  [[ZhenLiaoRecordCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZhenLiaoDetailViewController *detailVC = [[ZhenLiaoDetailViewController alloc]initWithPageName:@"ZhenLiaoRecordViewController"];
...
//        if (!result.hasError) {
//            ZhenLiaoDetailViewController *detailVC = [[ZhenLiaoDetailViewController alloc]initWithPageName:@"ZhenLiaoRecordViewController"];
//            ZhenLiaoRecord *record = result.parsedModelObject;
//            detailVC.data = record;
//            [self.slideNavigationController pushViewController:detailVC animated:YES];
//        }
//    } pageName:@"ZhenLiaoRecordViewController"];
