...
#define kZhenLiaoRecordCellHeight 155.0

@interface ZhenLiaoRecordCell()
{
    UILabel *label1;
    UILabel *label2;
    UILabel *label3;
...
@implementation ZhenLiaoRecordCell

+ (CGFloat)defaultHeight
{
    return kZhenLiaoRecordCellHeight;
}
...
- (void)createSubViews{
    ...
    UIView *baseView = [[UIView alloc]initWithFrame:CGRectMake(KTableViewCellLeftDistence, 7.5, kScreenWidth-KTableViewCellLeftDistence*2,kZhenLiaoRecordCellHeight - 15)];
