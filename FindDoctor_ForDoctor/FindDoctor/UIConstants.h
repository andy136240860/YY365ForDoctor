...
#define kDarkGreenColor    UIColorFromRGB(65, 156, 159) //UIColorFromRGB(78, 163, 25)
#define kYellowColor       UIColorFromRGB(238, 166, 48)
#define kBlackColor        UIColorFromHex(0x333333)
#define kDarkGrayColor     UIColorFromRGB(81, 81, 81)
...
#define kHalfTableViewCellInteralY  7.5

#define ksubViewWeith (kScreenWidth-KTableViewCellLeftDistence*2)
#define kleftPadding 9
